...
class EmployeeProviders with ChangeNotifier {
  MasterController controller = MasterController(FirebaseServicesAdmin());
...
class NotificationsProviders with ChangeNotifier {
  ...
  List<NotificationsAdmin> _NotificationsAdminList = [];
  List<NotificationsAdmin> get NotificationsAdminList => this._NotificationsAdminList;

  set NotificationsAdminList(List<NotificationsAdmin> value) {
    this._NotificationsAdminList = value;
