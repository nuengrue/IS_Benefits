...
class _AddEduPageState extends State<AddEduPage> {
  ...
  final List<String> _academyName = [
    ...
    final List<String> _educationlevelName = [
    "อนุบาล",
    "ประถมต้น",
    "ประถมปลาย"
  ];
...
_payamount = "0";
 _paydate  = "";
      ...
      Provider.of<EducationProviders>(context, listen: false)
          .addEducation(
      _no,
      _empcode,
      _name,
...
//
      ...
      CollectionReference educations =  FirebaseFirestore.instance.collection('Education');
      DocumentReference doc = await educations
      .add({
        'no': _no,
        'empcode':      _empcode,
        'name':      _name,
